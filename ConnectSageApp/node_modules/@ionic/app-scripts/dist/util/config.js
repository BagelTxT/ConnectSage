...
function generateContext(context) {
    ...
    var closureCompilerJarPath = path_1.join(getProcessEnvVar(Constants.ENV_VAR_APP_SCRIPTS_DIR), 'bin', 'closure-compiler.jar');
    setProcessEnvVar(Constants.ENV_CLOSURE_JAR, closureCompilerJarPath);
    logger_1.Logger.debug("closureCompilerJarPath set to " + closureCompilerJarPath);
    ...
    var printOriginalDependencyTree = getConfigValue(context, '--printOriginalDependencyTree', null, Constants.ENV_PRINT_ORIGINAL_DEPENDENCY_TREE, Constants.ENV_PRINT_ORIGINAL_DEPENDENCY_TREE.toLowerCase(), null);
    setProcessEnvVar(Constants.ENV_PRINT_ORIGINAL_DEPENDENCY_TREE, printOriginalDependencyTree);
    logger_1.Logger.debug("printOriginalDependencyTree set to " + printOriginalDependencyTree);
    var printModifiedDependencyTree = getConfigValue(context, '--printModifiedDependencyTree', null, Constants.ENV_PRINT_MODIFIED_DEPENDENCY_TREE, Constants.ENV_PRINT_MODIFIED_DEPENDENCY_TREE.toLowerCase(), null);
    setProcessEnvVar(Constants.ENV_PRINT_MODIFIED_DEPENDENCY_TREE, printModifiedDependencyTree);
    logger_1.Logger.debug("printModifiedDependencyTree set to " + printModifiedDependencyTree);
    ...
    var purgeDecorators = getConfigValue(context, '--purgeDecorators', null, Constants.ENV_PURGE_DECORATORS, Constants.ENV_PURGE_DECORATORS.toLowerCase(), 'true');
    setProcessEnvVar(Constants.ENV_PURGE_DECORATORS, purgeDecorators);
    logger_1.Logger.debug("purgeDecorators set to " + purgeDecorators);
    var manualTreeshaking = getConfigValue(context, '--manualTreeshaking', null, Constants.ENV_MANUAL_TREESHAKING, Constants.ENV_MANUAL_TREESHAKING.toLowerCase(), 'true');
    setProcessEnvVar(Constants.ENV_MANUAL_TREESHAKING, manualTreeshaking);
    logger_1.Logger.debug("manualTreeshaking set to " + manualTreeshaking);
    /* Experimental Flags */
    var useExperimentalClosure = getConfigValue(context, '--useExperimentalClosure', null, Constants.ENV_USE_EXPERIMENTAL_CLOSURE, Constants.ENV_USE_EXPERIMENTAL_CLOSURE.toLowerCase(), null);
    setProcessEnvVar(Constants.ENV_USE_EXPERIMENTAL_CLOSURE, useExperimentalClosure);
    logger_1.Logger.debug("useExperimentalClosure set to " + useExperimentalClosure);
    var useExperimentalBabili = getConfigValue(context, '--useExperimentalBabili', null, Constants.ENV_USE_EXPERIMENTAL_BABILI, Constants.ENV_USE_EXPERIMENTAL_BABILI.toLowerCase(), null);
    setProcessEnvVar(Constants.ENV_USE_EXPERIMENTAL_BABILI, useExperimentalBabili);
    logger_1.Logger.debug("useExperimentalBabili set to " + useExperimentalBabili);
    ...
    var buildToEs5 = getConfigValue(context, '--buildToEs5', null, Constants.ENV_BUILD_TO_ES5, Constants.ENV_BUILD_TO_ES5.toLowerCase(), useExperimentalClosure ? null : 'true');
