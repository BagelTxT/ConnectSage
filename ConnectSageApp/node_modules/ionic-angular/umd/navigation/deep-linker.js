(function (factory) {
    ...
    var DeepLinker = (function () {
        ...
        DeepLinker.prototype.navChange = function (direction) {
            if (direction) {
                var /** @type {?} */ rootNavContainers = this._app.getActiveNavContainers();
                ...
                var /** @type {?} */ segments = [];
                for (var _i = 0, rootNavContainers_1 = rootNavContainers; _i < rootNavContainers_1.length; _i++) {
                    var rootNavContainer = rootNavContainers_1[_i];
                    if (nav_util_1.isTabs(rootNavContainer) || ((rootNavContainer)).isTransitioning()) {
                        return;
                    }
                    var /** @type {?} */ segmentsForNav = this.getSegmentsFromNav(rootNavContainer);
