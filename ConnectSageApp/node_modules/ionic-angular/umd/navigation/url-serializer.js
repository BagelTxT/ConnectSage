(function (factory) {
    ...
    var UrlSerializer = (function () {
        ...
        UrlSerializer.prototype.parse = function (browserUrl) {
            ...
            return exports.parseUrlParts(navGroups, this.links);
        };
        /**
         * @param {?} navContainer
    ...
    exports.parseUrlParts = function (navGroups, configLinks) {
        var /** @type {?} */ segments = [];
            ...
            for (var _a = 0, navGroups_1 = navGroups; _a < navGroups_1.length; _a++) {
                ...
                if (link.segmentPartsLen === navGroup.segmentPieces.length) {
                    ...
                    for (var /** @type {?} */ i = 0; i < navGroup.segmentPieces.length; i++) {
                        if (!exports.isPartMatch(navGroup.segmentPieces[i], link.segmentParts[i])) {
                    ...
                    if (allSegmentsMatch) {
                        segments.push({
                            ...
                            data: exports.createMatchedData(navGroup.segmentPieces, link),
